%% init camera and set properties, working with matrix vision bluefox3 
% Input: NumberOfcapturedFrames is the number of the frames nedd to be
% captured
...
% Choose=input('Full 120 FPS 8 Samples 165 Flicker - 1, default 720p 240 fps 16 Samples 210 Hz ');
% if Choose==1
%     %Full Resolution 210 Hz Flicker 16 Samples
% else
%     vid.ROIPosition = [328 248 1280  720]; %Partial R
% end
%  
